<template>
  <transition name="slide">
    <div v-show="showFlag" v-if="food" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :desc="desc"
                        :ratings="food.ratings"
                        :only-content="onlyContent"
                        @ratingTypeSelect="ratingTypeSelect"
                        @ratingContentToggle="ratingContentToggle"></ratingselect>
...
<script>
  ...
  export  default{
    ...
    methods: {
      ...
      addFirst(event) {
        this.$emit('cartAdd', event.target);  //小球动画
  ...
  .food {
    ...
    .content {
      ...
      .buy {
        ...
        &.fade-enter-active, &.fade-leave-active { //这里设置动画一则为了效果，二则为了保证在小球动画时能找到ball.el.getBoundingClientRect
          transition: all 1s;
          opacity: 1;
        }
